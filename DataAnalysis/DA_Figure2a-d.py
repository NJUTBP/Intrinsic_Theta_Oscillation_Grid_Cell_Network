...
Description: Analyzing data for Figure 2a-d
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure2a-d/Hist_normal.npz',histE=histE,histI=histI,Nedges=Nedges,Tedges=Tedges)
    np.savez_compressed('../Data/DA_Figure2a-d/Hist_zoomin.npz',histEZ=histEZ,NedgesZ=NedgesZ,TedgesZ=TedgesZ)
