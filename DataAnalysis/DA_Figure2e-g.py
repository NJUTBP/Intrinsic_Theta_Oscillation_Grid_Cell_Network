...
Description: Analyzing data for Figure 2e-g
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure2e-g/VEPSD.npz',f=f,Pxxs=Pxxs)
    np.savez_compressed('../Data/DA_Figure2e-g/VEs.npz',VEs=VEs,VEIds=VEIds)
