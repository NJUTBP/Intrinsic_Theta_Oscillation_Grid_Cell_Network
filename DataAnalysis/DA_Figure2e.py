...
Description: Analyzing data for Figure 2e
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure2e/Currents.npz',CurrentIEs=CurrentIEs,CurrentBEs=CurrentBEs,CurrentLEs=CurrentLEs,CurrentEIs=CurrentEIs,CurrentIIs=CurrentIIs,CurrentBIs=CurrentBIs,CurrentLIs=CurrentLIs)
