...
Description: Analyzing data for Figure 2h
"""
...
def main():
    ...
    VEs=np.load('../Data/DA_Figure2e-g/VEs.npz')['VEs']
    ...
    np.savez_compressed('../Data/DA_Figure2h/PeaksInTheta.npz',PeakInTheta_SimpleS=PeakInTheta_SimpleS,
