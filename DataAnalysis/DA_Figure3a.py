...
Description: Analyzing data for Figure 3a
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure3a/SpikeInBump_'+str(TrialID)+'.npz',SpikeInBump=SpikeInBump,PVtime=PVs[:,0],FinalPV=FinalPV)
