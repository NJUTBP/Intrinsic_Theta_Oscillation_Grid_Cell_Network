...
Description: Analyzing data for Figure 3b-d
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure3b-d/PSD.npz',Freq=Freq,PE=Pxx_denE,PII=Pxx_denIin,PIO=Pxx_denIout)
    ...
    np.savez_compressed('../Data/DA_Figure3b-d/spikepeakfs.npz',spikepeakf=spikepeakf,spikepeakfintheta=spikepeakfintheta)
