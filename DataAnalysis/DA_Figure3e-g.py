...
def VersusParam():
    ...
    np.savez_compressed('../Data/DA_Figure3e-g/HWs.npz',MeanEnF=MeanEnF,StdEnF=StdEnF,NumSpkInTheta=NumSpkInTheta)
    ...
    plt.show()
    print(MeanEnF,StdEnF,NumSpkInTheta)
    np.savez_compressed('../Data/DA_Figure3e-g/DCs.npz',MeanEnF=MeanEnF,StdEnF=StdEnF,NumSpkInTheta=NumSpkInTheta)
