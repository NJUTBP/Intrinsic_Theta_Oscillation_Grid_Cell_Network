...
Description: Analyzing data for Figure 3i
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure3i/PhaseLockIndex.npz',PLI=PhaseLockIndex)
    np.savez_compressed('../Data/DA_Figure3i/SpikeNum.npz',SpikeNum=SpikeNum)
