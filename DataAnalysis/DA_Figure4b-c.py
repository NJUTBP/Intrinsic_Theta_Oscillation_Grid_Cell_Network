...
Description: Analyzing data for Figure 4b-c
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_Figure4b-c/TauIE.npz',MeanEnF=MeanEnF,StdEnF=StdEnF,NumSpkInTheta=NumSpkInTheta,StdPV=StdPV)
