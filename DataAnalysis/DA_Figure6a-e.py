...
Description: Analyzing data for Figure 6a-e
"""
...
def PopulationVector():
    ...
    np.savez_compressed('../Data/DA_Figure6d-f/AllPVs.npz',PVA=FinalPVA,
                                                            PVL=FinalPVL)
...
def ThetaRhythm():
    ...
    np.savez_compressed('../Data/DA_Figure6d-f/ThetaRhythm.npz',Energyintheta=Energyintheta,
