...
Description: Analyzing data for Figure 6a-f
"""
#### importing packages ####
import numpy as np
...
def PSDAbstract():
    ...
    np.savez_compressed('../Data/DA_Figure6a-f/AllData.npz',FFList=FFList,
                                                            PSD=PSD,
                                                            Freq=Freq,
...
def SCvsInput():
    ...
    np.savez_compressed('../Data/DA_Figure6a-f/AllPeaksInTheta.npz',AllPeakInTheta_SimpleS=AllPeakInTheta_SimpleS,
                                                                    AllPeakInTheta_FilterS=AllPeakInTheta_FilterS,
                                                                    AllPeakInTheta_AutoCor=AllPeakInTheta_AutoCor)
    np.savez_compressed('../Data/DA_Figure6a-f/AllPhaseLockIndex.npz',AllPhaseLockIndex=AllPhaseLockIndex)
...
def SpikePhase():
    ...
    np.savez_compressed('../Data/DA_Figure6a-f/SpikePhaseLockIndex.npz',AllPhaseLockIndex=AllPhaseLockIndex)
        
def Resonance():
    FFList=np.load('../Data/DA_Figure6a-f/AllData.npz')['FFList']
    PSD=np.load('../Data/DA_Figure6a-f/AllData.npz')['PSD']
    Freq=np.load('../Data/DA_Figure6a-f/AllData.npz')['Freq']
    spikepeakf=np.load('../Data/DA_Figure6a-f/AllData.npz')['spikepeakf']
    print(FFList.shape)
    print(PSD.shape)
    print(Freq.shape)
    ...
    np.savez_compressed('../Data/DA_Figure6a-f/Resonance.npz',PeakEnergy=PeakEnergy)
