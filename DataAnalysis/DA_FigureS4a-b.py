...
Description: Analyzing data for Figrue S4a-b
"""
...
def main():
    ...
    np.savez_compressed('../Data/DA_FigureS4a-b/ProfileAbstract.npz',Hie=Hie,Wie=Wie,Sie=Sie,Htau=Htau,Wtau=Wtau,Stau=Stau)
