...
Description: Generating data for Figure 2, 3, 4, 5, 6, S2, S3, S4, S5, S7.
"""
...
Stim2IEnd=500#T+1
IS2I0=np.zeros(NI)
Inhibit_I_width=0#4#8#12#16#20#24#28#32
IS2I0[:Inhibit_I_width]=0#-200
IS2I0[-Inhibit_I_width:]=0#-200
IS2I0[(int(NI/2)-Inhibit_I_width):(int(NI/2)+Inhibit_I_width)]=0#-200
